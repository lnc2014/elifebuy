...
//                 array('name'=>'系统公告','url'=>'default/test','acl'=>'home_test','list_acl'=>array()),
...
//           ),
    	'商品管理' => array(
    	   'controller'=>'post', 'url'=>'post/index', 'acl'=>'post','action'=>array(
                array('name'=>'商品管理','url'=>'post/index','acl'=>'post_index','list_acl'=>array(
                        '录入'=>'post_create', '编辑'=>'post_update', '批量审核'=>'post_verify', '批量推荐'=>'post_commend', '删除'=>'post_delete'
                        )),
                array('name'=>'商品分类管理','url'=>'post/catelist','acl'=>'catelist','list_acl'=>array(
                        '回复'=>'post_comment_update',  '删除'=>'post_comment_delete'
                        )),
                array('name'=>'商品套餐管理','url'=>'post/planlist','acl'=>'planlist'),
//                 array('name'=>'评论管理','url'=>'post/comment','acl'=>'post_comment','list_acl'=>array(
//                         '回复'=>'post_comment_update',  '删除'=>'post_comment_delete'
//                         )),
//                 array('name'=>'专题管理','url'=>'post/special','acl'=>'post_special','list_acl'=>array(
...
//     	'商品管理' => array(
//     	   'controller'=>'shop', 'url'=>'shop/index', 'acl'=>'shop','action'=>array(
//                 array('name'=>'商品管理','url'=>'shop/index','acl'=>'shop_index','list_acl'=>array(
//                         '增加商品'=>'shop_create', '编辑商品'=>'shop_update', '批量审核'=>'shop_verify', '删除'=>'shop_delete'
//                         )),
//         	)
//           ),
        '客户资料管理' => array(
            'controller'=>'order', 'url'=>'order/index', 'acl'=>'user','action'=>array(
                array('name'=>'客户信息列表','url'=>'order/index','acl'=>'admin_index','list_acl'=>array(
